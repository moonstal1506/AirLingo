...
CREATE TABLE `report` (
  ...
  KEY `FK5rskglf2yyeirids11udn58s5` (`report_item_id`),
  KEY `FKj62onw73yx1qnmd57tcaa9q3a` (`user_id`),
  CONSTRAINT `FK5rskglf2yyeirids11udn58s5` FOREIGN KEY (`report_item_id`) REFERENCES `report_item` (`report_item_id`),
...
-- Dump completed on 2023-08-16 11:04:20
